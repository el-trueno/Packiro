...
use Shopware\Core\Checkout\Promotion\Cart\PromotionCalculator as ShopwarePromotionCalculator;
...
/**
 * Overridden to be able to use \Packiro\Checkout\Calculator\Promotion\DiscountFixedUnitPriceCalculator
 */
class PromotionCalculator extends ShopwarePromotionCalculator
{
